...
import {
	ButtonGroup,
	ButtonGroupText,
} from "@notetaker-app/ui/components/button-group";
...
export const AudioPlayerElement = ({
	...props
}: AudioPlayerElementProps): React.ReactElement => (
	<audio
...
export const AudioPlayerControlBar = ({
	children,
	...props
}: AudioPlayerControlBarProps): React.ReactElement => (
...
export const AudioPlayerPlayButton = ({
	className,
	...props
}: AudioPlayerPlayButtonProps): React.ReactElement => (
	<Button
		render={
			<MediaPlayButton
...
export const AudioPlayerSeekBackwardButton = ({
	seekOffset = 10,
	...props
}: AudioPlayerSeekBackwardButtonProps): React.ReactElement => (
	<Button
		render={
			<MediaSeekBackwardButton
...
export const AudioPlayerSeekForwardButton = ({
	seekOffset = 10,
	...props
}: AudioPlayerSeekForwardButtonProps): React.ReactElement => (
	<Button
		render={
			<MediaSeekForwardButton
...
export const AudioPlayerTimeDisplay = ({
	className,
	...props
}: AudioPlayerTimeDisplayProps): React.ReactElement => (
	<ButtonGroupText
...
export const AudioPlayerTimeRange = ({
	className,
	...props
}: AudioPlayerTimeRangeProps): React.ReactElement => (
	<ButtonGroupText
		className="bg-transparent"
		render={
			<MediaTimeRange
...
export const AudioPlayerDurationDisplay = ({
	className,
	...props
}: AudioPlayerDurationDisplayProps): React.ReactElement => (
	<ButtonGroupText
		className="bg-transparent"
		render={
			<MediaDurationDisplay
...
export const AudioPlayerMuteButton = ({
	className,
	...props
}: AudioPlayerMuteButtonProps): React.ReactElement => (
	<ButtonGroupText
		className="bg-transparent"
		render={
			<MediaMuteButton
...
export const AudioPlayerVolumeRange = ({
	className,
	...props
}: AudioPlayerVolumeRangeProps): React.ReactElement => (
	<ButtonGroupText
		className="bg-transparent"
		render={
			<MediaVolumeRange
