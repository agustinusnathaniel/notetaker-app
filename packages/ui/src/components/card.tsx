...
export function CardFrameAction({
	...
	const defaultProps = {
		className: cn(
			"col-start-2 nth-3:row-span-2 nth-3:row-start-1 inline-flex self-center justify-self-end max-sm:col-start-1 max-sm:row-span-1 max-sm:row-start-auto max-sm:self-start max-sm:justify-self-stretch",
			className
		),
